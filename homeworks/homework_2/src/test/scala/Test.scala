...
object Test extends TestSuite {
  ...
  val tests = Tests {
    ...
    'sortByHeavyweight - {
      ...
      assert(Exercises.sortByHeavyweight(Map("Sodium" -> (5, 0.971), "Chrome" -> (3, 7.18), "Plutonium" -> (3, 19.25))) == Seq("Sodium", "Chrome", "Plutonium"))
      assert(Exercises.sortByHeavyweight(Map("1" -> (100, 1000), "2" -> (50, 100), "3" -> (1, 1))) == Seq("3", "2", "1"))
