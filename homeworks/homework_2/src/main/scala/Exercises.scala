object Exercises {
    ...
    def sumByFunc(leftVec0: Vector2D, leftVec1: Vector2D, magicMethod:(Vector2D,Vector2D)=>Double, rightVec0: Vector2D, rightVec1: Vector2D): Double = {
    ...
    */
    ...
    def sortByHeavyweight(ballsArray: Map[String, (Int, Double)] = balls): Seq[String] = {
        val m = ballsArray.map { case (k, v) =>
            val newValue = calculateMass(v._1, v._2)
            k -> newValue
        }
