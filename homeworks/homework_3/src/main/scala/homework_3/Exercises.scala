...
object Exercises {
    ...
    def prettyBooleanFormatter2(x: Any): String = if (x.getClass.equals(classOf[java.lang.Boolean])) {
    ...
    private class SomeIterable[T](val i: T*) extends Iterable[T] {
        override def iterator: Iterator[T] = i.toIterator
    }
