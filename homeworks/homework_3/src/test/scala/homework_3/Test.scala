...
object Test {
  def main(args: Array[String]): Unit = {
    prettyBooleanFormatterTests()
    maxTests()
    sumTests()
  }
  
  def prettyBooleanFormatterTests(): Unit = {
    val trueStr = "правда"
    val falseStr = "ложь"
    val num = 123
    val str = "I am string"
  ...
  def maxTests(): Unit = {
    assertThrows[Exception](Exercises.max1(Seq()))(_.getMessage == "Cannot find max value of empty sequence")
