...
object Test extends TestSuite{
    ...
    val tests = Tests{
        ...
        'test_prettyBooleanFormatter1 - {
            ...
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter1, 1337, "1337")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter1, new CustomClass(1, "NikitaSamkov"), "1: NikitaSamkov")
        ...
        'test_prettyBooleanFormatter2 - {
            ...
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter2, 1337, "1337")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter2, new CustomClass(1, "NikitaSamkov"), "1: NikitaSamkov")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter1, true, "правда")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter1, false, "ложь")
        }
        'test_prettyBooleanFormatter3 - {
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter3, "string", "string")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter3, 1337, "1337")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter3, new CustomClass(1, "NikitaSamkov"), "1: NikitaSamkov")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter1, true, "правда")
            testPrettyBooleanFormatter(Exercises.prettyBooleanFormatter1, false, "ложь")
        }
        'test_max1 - {
        ...
        'test_sum1 - {
            ...
            testSum(Exercises.sum1, -1337, -5051, -6388)
        ...
        'test_sum2 - {
            ...
            testSum(Exercises.sum2, -1337, -5051, -6388)
        ...
        'test_sum3 - {
            ...
            testSum(Exercises.sum3, -1337, -5051, -6388)
